...
public class Frame extends JFrame {
	...
	/**
	 * Defines and runs a Thread that updates the Gui every 100ms. Can be
	...
	/**
	 * Sets the specific Gui Mode: 0 = Make frame invisible 1 = StartupGui 2 =
	 * StartGameGui (Webcam only) 3 = Start Webcam-HumanGui 4 = Start
	 * Computer-HumanGui
	 */
